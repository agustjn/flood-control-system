<template>
  ...
  <div>
    ...
    <div>
      ...
      <textarea v-model="form.description" placeholder="ingrese una descripción de la denuncia"></textarea>
    </div>
    <div>
      <label class="form-label" for="">Nombre: </label>
      <input class="form-input" type="text" placeholder="nombre" v-model="form.first_name">
    </div>
    <div>
      <label class="form-label" for="">Apellido: </label>
      <input class="form-input" type="text" placeholder="apellido" v-model="form.last_name">
    </div>
    <div>
      <label class="form-label" for="">Telefono: </label>
      <input class="form-input" type="text" placeholder="telefono" v-model="form.phone">
    </div>
    <div>
      <label class="form-label" for="">E-mail: </label>
      <input class="form-input" type="text" placeholder="mail" v-model="form.email">
    </div>
  </div>
